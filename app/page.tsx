...
return (
  <main className="relative text-white">
    ...
    {/* Hero */}
    <section className="flex min-h-screen flex-col items-center justify-center px-4 text-center md:px-6">
      <h1 className="mb-6 text-4xl tracking-[0.15em] sm:text-5xl md:text-8xl md:tracking-[0.4em]">
        NIRMALA
      </h1>

      <p className="mb-3 text-base text-blue-200 md:text-xl">
        Ruang untuk memahami rasa melalui bahasa
      </p>

      <p className="mb-10 max-w-2xl px-2 text-sm text-white/70 md:px-0 md:text-base">
    ...
    <section
      id="fitur"
      ref={fiturRef}
      className="flex min-h-screen items-center justify-center px-4 md:px-6"
    >
      <div
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-8">
          ...
          {/* Cermin Emosi */}
          <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md md:p-8">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-md md:p-8">
            ...
            <p className="mb-6 text-sm text-white/70 md:text-base">
              Simpan dan lihat kembali jejak tulisan, puisi,
              serta refleksi perasaan yang pernah kamu buat.
            </p>
    ...
    <section
      id="tentang"
      ref={tentangRef}
      className="flex min-h-screen items-center justify-center px-4 text-center md:px-6"
    >
      <div
      ...
      >
        ...
        <p className="leading-7 text-sm text-white/70 md:leading-8 md:text-base">
